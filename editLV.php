...
if(isset($_GET['id_linhvuc'])){
    $sql = "SELECT * FROM linhvuc where id_linhvuc = " .$_GET['id_linhvuc'];
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_array($result);
}

if(isset($_POST['update'])){
    $ten = $_POST['ten_linhvuc'];
    $update = "UPDATE linhvuc SET ten_linhvuc='$ten' where id_linhvuc= ". $_GET['id_linhvuc'];
    $up = mysqli_query($conn, $update);
    if(!isset($sql)){
        die("Error $sql" .mysqli_connect_error());
    }else{
        echo '<script language="javascript">alert("Cập nhật lĩnh vực thành công!"); window.location="QLLV.php";</script>';
        // header("location:QLLV.php");
    }
}
?>
<!DOCTYPE html>
        ...
        <div class="header">
            ...
            <div style="margin-left: 350px;">
                <form method="post">
                    ...
                    <label style="margin-left:400px ;">TÊN LĨNH VỰC:</label>
                    <input type="text" name="ten_linhvuc" value="<?php echo $row['ten_linhvuc']; ?>" required><br/><br/>
                    <button style="margin-left:400px ;" type="submit" name="update" id="update">Update</button>
                    <a href="QLLV.php"><button style="margin-right:350px ;" type="button" value="button">Cancel</button></a>
                </form>
