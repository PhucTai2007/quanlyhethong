            ...
            <div>
               <table border="1" style="margin:0 auto;">
                    <tr>
                        ...
                        <th rowspan="2">Số GCN</th>
                        <th colspan="2">Thời hạn</th>
                    ...
                    <?php
                        ...
                        INNER JOIN coso_linhvuc on coso.id_coso = coso_linhvuc.id_coso
                    ...
                    <tr>
                        ...
                        <!-- <td><a href="deleteCS.php?id_coso=<?php echo $row['id_coso']; ?>" id="xoa">Xóa</a></td> -->
                    </tr>
                    <?php
                    }
                    ?>
                ...
                <?php
                    ...
                    for($t=1 ; $t <= $sotrang   ; $t++){
                            echo "<a href='QLCSoff.php?trang=$t'> trang $t --</a> ";
                    }
                ?>
                </div>
                <!-- <br> -->
