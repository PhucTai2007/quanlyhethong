        ...
        <div class="header">
            ...
            <div style="margin-left: 850px;">
				<table border="1">
					...
					<?php 
						require 'connect.php';
						$query=mysqli_query($conn,"select * from `linhvuc` WHERE trangthai_MD='1'");
					...
					<tr>
						...
						<td><a href="RupdatetrangthaiLV.php?id_linhvuc=<?php echo $row['id_linhvuc']; ?>">Cập nhật trạng thái</a></td>
