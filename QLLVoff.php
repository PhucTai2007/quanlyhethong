     ...
     <body>
        <div class="header">
            <div class="container">
                ...
                <h1 style="text-align: center;"><b>Quản lí lĩnh vực chưa hoạt động</b></h1>
            <div style="margin-left: 350px;">
				<table border="1">
					...
					<?php 
                        ...
                        $sotin1trang = 10;
                        $from = ($trang - 1) * 10;
						$query=mysqli_query($conn,"select * from `linhvuc` WHERE trangthai_MD='1' LIMIT $from , $sotin1trang");
                        $i = 0;
					...
					<tr>
						...
						<td><a href="RupdatetrangthaiLV.php?id_linhvuc=<?php echo $row['id_linhvuc']; ?>">Cập nhật</a></td>
						<!-- <td><a href="deleteLV.php?id_linhvuc=<?php echo $row['id_linhvuc']; ?>">Xóa</a></td> -->
					</tr>
					<?php
					}
					?>
                ...
                <?php
                    require 'connect.php';
                    $x = mysqli_query($conn,"SELECT id_linhvuc from linhvuc WHERE trangthai_MD='1' ");
                    $tongsotin = mysqli_num_rows($x);
                    $sotrang = ceil( $tongsotin / $sotin1trang);
                    for($t=1 ; $t <= $sotrang   ; $t++){
                            echo "<a href='QLLVoff.php?trang=$t'> trang $t --</a> ";
                    }
                ?>
                </div><br>
                <button onclick="document.location='themLV.php'">Thêm</button>
                <button onclick="document.location='QLLV.php'">Lĩnh vực</button>
